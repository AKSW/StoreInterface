...
class StackTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $triple1 = new \Saft\StoreInterface\Triple('a1', 'b1', 'c1');
    ...
    {
        $quad1 = new \Saft\StoreInterface\Quad('a2', 'b2', 'c2', 'd2');
        $this->assertEquals('a2', $quad1 -> getSubject());
    }

    public function testStatementWithEmptyVariables()
    {
        $quad1 = new \Saft\StoreInterface\Quad('', "", null, 'd2');
    ...
    public function testSparqlFormat()
    {
        ...
        $triple2 = new \Saft\StoreInterface\Triple('<a1>', '<b1>', '<c1>');
        $this->assertEquals('<a1>', $triple2 -> getSubject(true));
        $this->assertEquals('<a1>', $triple2 -> getSubject());

        $triple3 = new \Saft\StoreInterface\Triple('?a', 'b1', 'c1');
